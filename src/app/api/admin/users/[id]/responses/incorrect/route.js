...
// GET - получение карточек с неправильными ответами пользователя
export async function GET(request, { params }) {
  try {
    ...
    // Получаем карточки с неправильными ответами (последний ответ на каждую карточку)
    const sql = `
    ...
    console.error('Error fetching user incorrect responses:', error);
